...
// https://www.igvita.com/slides/2012/devtools-tips-and-tricks/jank-demo.html after reading the explanation 
...
function updatePositions() {
  ...
  var hiPosition = document.body.scrollTop / 1250;
 
  //replaced querySelectorAll with getElementsByClassName To better performance 
  // the update position code is Borrowed from here https://discussions.udacity.com/t/project-4-how-do-i-optimize-the-background-pizzas-for-loop/36302
  ...
  for (i = 0; i < 5; i++) {
      constArray.push(Math.sin((hiPosition / 1250) + i));
    }
