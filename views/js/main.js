...
function updatePositions() {
  ...
  // the update position code is Borrowed from here https://discussions.udacity.com/t/project-4-how-do-i-optimize-the-background-pizzas-for-loop/36302 after reading the explation
  ...
  for (i = 0; i < 5; i++) {
      constArray.push(Math.sin((hiPosition) + i));
    }
